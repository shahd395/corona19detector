...
def runJob():
    ...
    if form.getvalue('q1'):
        ...
        q1 = 'نتيجة الفحص : مصاب '\n 'تبعاً لشعورك بأعراض مرض كوفيد-19 فمبدئياً يمكننا القول بأنك مصاب، ويترتب على ذلك' \n 'إجراء فحص مخبري للتأكد من الإصابة' \n 'الالتزام بالعزل المنزلي وإن ساءت حالتك الصحية قم بالاتصال بالجهات المسؤولة '\n 'تابع مع طبيبك حتى وإن كانت حالتك جيدة، ابقَ على اتصالٍ معه والتزم بكافة نصائحه وتعليماته '
        result = 'نتيجة الفحص : مصاب '\n 'تبعاً لشعورك بأعراض مرض كوفيد-19 فمبدئياً يمكننا القول بأنك مصاب، ويترتب على ذلك' \n 'إجراء فحص مخبري للتأكد من الإصابة' \n 'الالتزام بالعزل المنزلي وإن ساءت حالتك الصحية قم بالاتصال بالجهات المسؤولة '\n 'تابع مع طبيبك حتى وإن كانت حالتك جيدة، ابقَ على اتصالٍ معه والتزم بكافة نصائحه وتعليماته '
